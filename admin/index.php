            ...
            case "update_phim" : {
                if ($_SERVER['REQUEST_METHOD'] == 'POST') {
                    ...
                    if (!empty($_FILES['poster']['name'])) {
                        ...
                        // Nếu không có file mới, giữ nguyên poster hiện tại
                        $poster = get_current_poster_name($id_phim);
                    }
                    ...
                    if (!empty($_FILES['banner']['name'])) {
                        ...
                        $banner = get_current_poster_name($id_phim);
                    }
