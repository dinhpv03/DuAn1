                            ...
                            <div class="col-md-6 col-lg-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-black">
                                    <form method = 'post'>
                                        ...
                                        <div class="pt-1 mb-4">
                                            <button class="btn btn-dark btn-lg btn-block" type="submit">Đang nhập</button>
                                        </div>

                                        <p class="mb-5 pb-lg-2" style="color: #393f81;">Bạn có tài khoản chưa? <a href="#!"style="color: #393f81;">Chưa thì thôi</a></p>
