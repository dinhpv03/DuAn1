        ...
        <div class="container py-5">
            <div class="row g-5">
                <div class="col-lg-3 col-md-6">
                    <h5 class="text-white mb-3">VỀ NATURE CINEMA</h5>
                    <a class="btn btn-link" href="">Về chúng tôi</a>
                    <a class="btn btn-link" href="">Liên hệ với chúng tôi</a>
                    <a class="btn btn-link" href="">Chính sách baỏ mật</a>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <p class="mb-2"><i class="fa fa-map-marker-alt me-3"></i>13 Trinh Van Bo Street, Hanoi, Vietnam</p>
                ...
                <div class="col-lg-3 col-md-6">
                    ...
                    <div class="row g-2 pt-2">
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="admin/style/img/banner_1.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="admin/style/package-2.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="admin/style/package-3.jpg" alt="">
                        </div>
                        <div class="col-4">
                            <img class="img-fluid bg-light p-1" src="admin/style/package-2.jpg" alt="">
                        </div>
        ...
        <div class="container">
            <div class="copyright">
                <div class="row justify-content-center">
                    <div class="col-2 text-center text-md-start mb-3 mb-md-0">
                        <a class="border-bottom" href="index.php">&copy; Nature Cinema</a>
                    </div>
                </div>
            </div>
    </div>
