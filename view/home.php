...
<?php 
    ...
    foreach ($phim_vs_loai_phim as $film) {
        ...
        $html_slide.= '<div class="carousel-item '.$act.'">
                            <img src="admin/style/img/'.$banner.'" alt="Slide '.$id_phim.'" style="width: 100%; height: 700px;">
                        </div>';
    }
    ...
    <div class="container mt-4">
        ...
        <div class="row g-4 justify-content-center">
            ...
            <!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="package-item">
                    ...
                    <div class="d-flex border-bottom">
                        <small class="flex-fill text-center border-end py-2"><i class="fa-solid fa-bars fa-sm" style="color: #88b816;"></i> Hành động</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>06/11/2023</small>
                        <small class="flex-fill text-center py-2"><i class="fa-solid fa-clock fa-sm" style="color: #88b816;"></i> 136 phút</small>
                    </div>
                    <div class="text-center p-4">
                        <h5 class="mb-0 text-truncate"><a href="index.php?act=chi_tiet_phim">Avengers: Endgame</a></h5>
                        <div class="mb-3">
            ...
            <!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.1s">
                <div class="package-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="admin/style/img/age-of-ultron.jpg" alt="">
                    </div>
                    <div class="d-flex border-bottom">
                        <small class="flex-fill text-center border-end py-2"><i class="fa-solid fa-bars fa-sm" style="color: #88b816;"></i> Hành động</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>06/11/2023</small>
                        <small class="flex-fill text-center py-2"><i class="fa-solid fa-clock fa-sm" style="color: #88b816;"></i> 101 phút</small>
                    </div>
                    <div class="text-center p-4">
                    <h5 class="mb-0 text-truncate"><a href="index.php?act=chi_tiet_phim">Avengers: Age of Ultron</a></h5>
                        <div class="mb-3">
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
            ...
            <!-- <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.3s">
                <div class="package-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="admin/style/img/iron-man.jpg" alt="">
                    </div>
                    <div class="d-flex border-bottom">
                    ...
                    <div class="text-center p-4">
                    <h5 class="mb-0 text-truncate"><a href="index.php?act=chi_tiet_phim">Iron Man</a></h5>
                        <div class="mb-3">
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
            ...
            <div class="col-lg-3 col-md-6 wow fadeInUp" data-wow-delay="0.5s">
                <div class="package-item">
                    <div class="overflow-hidden">
                        <img class="img-fluid" src="admin/style/img/thor.jpg" alt="">
                    </div>
                    <div class="d-flex border-bottom">
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-map-marker-alt text-primary me-2"></i>Indonesia</small>
                        <small class="flex-fill text-center border-end py-2"><i class="fa fa-calendar-alt text-primary me-2"></i>3 days</small>
                    ...
                    <div class="text-center p-4">
                        <h5 class="mb-0 text-truncate"><a href="index.php?act=chi_tiet_phim">Thor: The Dark World</a></h5>
                        <div class="mb-3">
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
                            <small class="fa fa-star text-primary"></small>
